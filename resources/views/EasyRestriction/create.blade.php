                    ...
                    <div class="col-md-12 clients ">
                        ...
                        <div class="container-fluid main-bg">
                            ...
                            <div class="arrow-steps clearfix">
                                <div class="step current bg-primary"> <span> <a href="{{ route('EasyRestriction.tenant') }}">نوع
                                            المنتج</a></span> </div>
                                ...
                                <div class="d-flex align-content-center my-1">
                                    ...
                                    <div class="d-flex align-content-center my-1">
                                        ...
                                        <div class="d-flex align-content-center justify-content-sm-between">
                                            <label class="mt-3 ml-5">المبلغ المسحوب:</label><input type="text" name="amunt" class="form-control w-75 my-2">
                                            </div>

                                            <div class="d-flex align-content-center justify-content-sm-between">
                                                <label class="mt-3 ml-5">   التاريخ: </label><input type="date" name="date" class="form-control w-75 input-bg my-2">
                                                </div>

                                                <div class="d-flex align-content-center justify-content-sm-between">
                                                    <label class="mt-3 ml-5">  الوصف: </label><input type="text" name="Des" class="form-control w-75 my-2">
                                                    </div>

                                                    <div class="d-flex align-content-center justify-content-sm-between">
                                                        <label class="mt-3 ml-5">  المرفقات: </label><input type="file" class="form-control w-75 my-2">
                                                        </div>
