@extends('layouts.vertical', ['title' => 'فاتورة شراء'])
@section('content')
      <div class="container-fluid">
                  ...
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        ...
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="Purchase_orderss.html">فاتورة شراء</a>
                        </li>
                     </ul>
                  </div>
               </div>
            ...
            <section>
               <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2">  <a href="{{ route('Purchase_Invoices.create') }}" class="text-light">اضافة فاتورة شراء</a> <i class="fa-solid fa-plus"></i></button> <button class="btn btn-primary mx-2">تصدير قائمة فاتورة شراء  <i class="fa-solid fa-right-to-bracket mx-1"></i></button>  <button class="btn btn-primary mx-2">استيراد قائمة فاتورة شراء  <i class="fa-solid fa-right-to-bracket mx-1"></i></button></div>
               <div class="container my-3">
                  <div class="row">
                     <div class="col-md-12 hi-mohasba">
                        <h4 class="mx-4">فاتورة شراء</h4>
                     </div>
                  </div>
                    ...
                    <div class="row bg-light pb-4 brdr">
                        <div class="col-md-12 PurchaseInvoicess ">
                            <div>
                                ...
                                <h1 class="my-3">ليس لديك أي فاتورة شراء</h1>
                                <p class="text-secondary my-5">يوفر قيود صفحة خاصة بالفاتورة شراء للمساهمة في تسهيل التعاملات مع العملاء وملخص لبياناتهم.</p>
                                <button class="btn btn-primary mx-2 "> <a href="{{ route('Purchase_Invoices.create') }}" class="text-light">اضافة فاتورة شراء</a>  <i class="fa-solid fa-plus"></i></button> <button class="btn btn-primary">استيراد قائمة الفاتورة شراء  <i class="fa-solid fa-right-to-bracket mx-1"></i></button>
                            </div>
                        </div>
                    </div>
                  @endif
