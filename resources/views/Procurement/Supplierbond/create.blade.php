@extends('layouts.vertical', ['title' => 'اضافة سندات الموردين'])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-purch-order.html"> إنشاء سندات الموردين </a>
                    </li>
                </ul>
            </div>
    ...
    <section>
        ...
        <div class="container my-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <form action="{{ route('Supplierbond.create.post') }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
