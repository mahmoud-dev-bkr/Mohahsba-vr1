    ...
    <section>
        ...
        <div class="container my-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <form action="{{ route('Quotation.create.post') }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                ...
                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">الوصف</label><input name="description" type="text" class="form-control w-75 my-2">
                                </div>
                                ...
                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الإصدار</label><input name="Release_Date" type="date" class="form-control w-75 my-2">
                                </div>
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الاستحقاق </label><input name="due_date" type="date"
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ التوريد </label><input type="date" name="Supply_date"
                                    class="form-control w-75 my-2">
                            </div>
