@extends('layouts.vertical', ['title' => 'عروض الأسعار'])
@section('content')
      <div class="container-fluid">
                  ...
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        ...
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="clients.html">عروض الأسعار</a>
                        </li>
                     </ul>
                  </div>
               </div>
            ...
            <section>
               <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2">  <a href="{{ route('Quotation.create') }}" class="text-light">اضافة عروض الأسعار</a> <i class="fa-solid fa-plus"></i></button> <button class="btn btn-primary mx-2">تصدير قائمة عروض الأسعار  <i class="fa-solid fa-right-to-bracket mx-1"></i></button>  <button class="btn btn-primary mx-2">استيراد قائمة عروض الأسعار  <i class="fa-solid fa-right-to-bracket mx-1"></i></button></div>
                  ...
                  @if (count($Quotation) > 0)
                    ...
                    <section>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div >
                                    <table id="QuotationsTable" class="table text-center">
                    ...
                    <div class="row bg-light pb-4 brdr">
                        <div class="col-md-12 clients ">
                            <div>
                                ...
                                <h1 class="my-3">ليس لديك أي عروض الأسعار</h1>
                                <p class="text-secondary my-5">يوفر قيود صفحة خاصة بعروض الأسعار للمساهمة في تسهيل التعاملات مع عروض الأسعار وملخص لبياناتهم.</p>
                                <button class="btn btn-primary mx-2 "> <a href="{{ route('Quotation.create') }}" class="text-light">اضافة عروض الأسعار</a>  <i class="fa-solid fa-plus"></i></button> <button class="btn btn-primary">استيراد قائمة عروض الأسعار  <i class="fa-solid fa-right-to-bracket mx-1"></i></button>
                            </div>
                        </div>
                    </div>
                  @endif
...
@section('script')
    ...
    <script>
        ...
        function setQuotationsDatatable() {
