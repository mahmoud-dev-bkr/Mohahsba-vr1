        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="purchase-orders.html"> فاتورة مبيعات</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-purch-order.html"> إنشاء فاتورة مبيعات </a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                ...
                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الإصدار</label><input id="Date_start_id" name="Date_start" type="date" class="form-control w-75 my-2">
                                </div>
...
<script>
    ...
    function addCode() {
        ...
        cell5.innerHTML  = `<input style="width:100%" id="tax_on_product_${id}"     name="test[]" type="text" class="form-control w-100" disabled>`;
        cell6.innerHTML  = `<input id="price_unit_product_${id}"    name="test[]" type="text" class="form-control w-100">`;
        cell7.innerHTML  = `<input id="inc_desc_product_${id}" name="test[]" type="checkbox" class=" value="off" w-100" onclick="include(${id})">`;
        cell8.innerHTML  = `<input id="desc_product_${id}"     name="test[]" type="text" class="form-control w-100">`;
        cell9.innerHTML  = `<input id="desc_product_op_${id}"     name="test[]" type="text" class="form-control w-100">`;
        ...
        cell12.innerHTML = `<input id="Tax_value_${id}"  value="0"   name="test[]" type="text" class="form-control w-100">`;
        cell13.innerHTML = `<input style="width:100%" id="Total_${id}"     name="test[]" type="text" class="form-control w-100">`;
