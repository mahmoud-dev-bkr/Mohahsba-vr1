@extends('layouts.vertical', ['title' => 'دفع فاتورة مبيعات'])
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="purchase-orders.html"> دفع فاتورة مبيعات</a>
                    </li>
        ...
        <div class="container my-3">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4">دفع فاتورة مبيعات</h4>
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <form action="{{ route('sales_invoices.payment.post') }}" method="post">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">القيمة</label><input type="text" name="Amount" id="Amount" value="{{ $PurchaseInvoices->residual }}"
                                    class="form-control w-75 my-2" onfocusout="balance()">
                            </div>
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">المتبقي</label><input type="text"  id="total"
                                    class="form-control w-75 my-2" value="0" onfocusout="" name="residual">
                                <input type="text" disabled id="COSTresidual"
                                    class="form-control w-75 my-2" value="{{ $PurchaseInvoices->residual }}" hidden >
                            </div>
...
<script>
    function balance() {
        ...
        var COST = $('#COSTresidual').val();
        var residual = (Amount - COST);
        if (residual < 0 ) {
            residual = residual * -1;
        } else if (Amount == 0) {
            residual = 0;
