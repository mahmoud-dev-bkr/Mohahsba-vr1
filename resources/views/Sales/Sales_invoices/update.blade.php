@extends('layouts.vertical', ['title' => 'تعديل فاتورة شراء'])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-purch-order.html"> تعديل فاتورة شراء </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> تعديل فاتورة شراء</h4>
                </div>

            </div>
            <div class="row bg-light pb-4 brdr">

                <form action="{{ route('Purchase_Invoices.edit', $PurchaseInvoices->id) }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
