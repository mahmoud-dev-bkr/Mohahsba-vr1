            ...
            <div class="row">
                ...
                <div class="col-md-7 bg-white">
                    <div class="my-3 mx-3 head">
                        <h2>تجربة مجانية</h2>
                        <p class="fw-bold">لم تسجل بعد؟<span class="text-primary">جرب قيود مجاناً</span></p>
                        <button class="btn btn-outline-primary"><a href="sign-up.html">تجربة مجانية</a></button>
                    </div>
                </div>
            </div>
        </div>
